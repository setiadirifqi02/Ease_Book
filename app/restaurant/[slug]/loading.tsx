export default function Loading() {
  return (
    <div className="flex flex-col md:flex-row h-full w-full">
      <div className="w-ful md:w-5/12 bg-gray-400 h-screen animate-pulse p-2 md:p-4">
        <div className="mt-20  grid">
          <div className="h-5 bg-zinc-200 w-60 dark:bg-zinc-700 rounded"></div>
        </div>
        <div className="space-y-3 mt-5 mb-10 animate-pulse">
      ...
      <div className="hidden md:block w-full md:w-7/12 p-2 md:p-6 animate-pulse my-auto">
        <div className="h-5 bg-zinc-200 w-60 dark:bg-zinc-700 rounded mb-5"></div>
        <div className="flex flex-wrap gap-4">
          <div className="rounded-md bg-zinc-200 dark:bg-zinc-700 w-[220px] aspect-square"></div>
          <div className="rounded-md bg-zinc-200 dark:bg-zinc-700 w-[220px] aspect-square"></div>
          <div className="rounded-md bg-zinc-200 dark:bg-zinc-700 w-[220px] aspect-square"></div>
          <div className="rounded-md bg-zinc-200 dark:bg-zinc-700 w-[220px] aspect-square"></div>
        </div>
